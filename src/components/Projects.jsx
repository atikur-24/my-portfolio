      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-10">
        ...
        <div className="w-full bg-primary shadow-xl rounded-lg relative h-[700px] sm:h-[630px] lg:h-[600px]">
          ...
          <div className="p-5 space-y-8 md:space-y-3">
            ...
            <p className="secondary-color text-justify">
              This is a team project. The website will serve as a platform for users to book medicines, receive health suggestions, and access essential information about doctors for advice. Users can book appointments for various lab tests (e.g.,
              blood tests, urine tests) through the application.
            </p>
        ...
        <div className="w-full bg-primary shadow-xl rounded-lg relative h-[700px] sm:h-[630px] lg:h-[600px]">
          ...
          <div className="p-5 space-y-8 md:space-y-3">
            ...
            <p className="secondary-color text-justify">
              The website is a gym training center that caters to three main roles: students, trainers, and admins. students can see their selected classes. Include payment system for each selected class. after payment has successfully then the
              student enrolled this class.
            </p>
            <div className="absolute bottom-5 space-y-3">
              <div className="flex justify-between items-center gap-2">
        ...
        <div className="w-full bg-primary shadow-xl rounded-lg relative h-[700px] sm:h-[630px] lg:h-[600px]">
          ...
          <div className="p-5  space-y-8 md:space-y-3">
            ...
            <p className="secondary-color text-justify">
              A Education toy store for kids. The seller adds a toy for the customer and also updates his toy details, the seller only his toy removes and updates it.Visit new user toy cards then click the details button to redirect to the login
              page, after login then show all toy details.
            </p>
            <div className="absolute bottom-5 space-y-3">
              <div className="flex justify-between items-center gap-2">
        ...
        <div className="w-full bg-primary shadow-xl rounded-lg relative h-[700px] sm:h-[630px] lg:h-[600px]">
          ...
          <div className="p-5 space-y-8 md:space-y-3">
            ...
            <p className="secondary-color text-justify">
              It&apos;s basically a Thailand chef&apos;s information website, chef&apos;s recipes, and bio data. Users can explore the key components of Thai cuisine, and learn about the flavors. Users can like any recipe and gain knowledge about
              traditional cooking and Thai dishes.
            </p>
            <div className="absolute bottom-5 space-y-3">
              <div className="flex justify-between items-center gap-2">
        ...
        <div className="w-full bg-primary shadow-xl rounded-lg relative h-[700px] sm:h-[630px] lg:h-[600px]">
          ...
          <div className="p-5 space-y-8 md:space-y-3">
            ...
            <p className="secondary-color text-justify">
              This is a college booker website. Show all colleges card, graduation gallery and research paper in home page. When user click details button then show specific college details. User send rating and feedback in my college page.
            </p>
            <div className="absolute bottom-5 space-y-3">
              <div className="flex justify-between items-center gap-2">
