...
const Skills = () => {
    ...
    return (
        <section className="my-container" id="skills">
            ...
            {/* front-end & back-end skill part */}
            <div className={active ? "" : "hidden"}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                    <div className=' bg-[#1d293a] relative rounded-lg w-full text-[#DDDFE2] h-20 font-bold'>
                        <div className='flex justify-between p-5'>
                            <div className='flex gap-3'>
                                <p className ='text-xl'>HTML</p>
                            </div>
                            <div className='bg-color px-2 py-1 rounded-md'>
                                <p className="text-white">90%</p>
                            </div>
                        </div>
                
                        <div className="w-full absolute bottom-0  bg-gray-300 rounded-full h-2">
                            <div className="bg-color h-2 rounded-full w-[90%]"></div>
                        </div>
                    </div>
                    <div className=' bg-[#1d293a] relative rounded-lg w-full text-[#DDDFE2] h-20 font-bold'>
                        <div className='flex justify-between p-5'>
                    ...
                    <div className=' bg-[#1d293a] relative rounded-lg w-full text-[#DDDFE2] h-20 font-bold'>
                        ...
                        <div className="w-full absolute bg-gray-300 bottom-0 rounded-full h-2">
                            <div className="bg-color h-2 rounded-full w-[85%]"></div>
                        </div>
                    </div>
                    <div className=' bg-[#1d293a] relative rounded-lg w-full text-[#DDDFE2] h-20 font-bold'>
                        <div className='flex justify-between p-5'>
                    ...
                    <div className=' bg-[#1d293a] relative rounded-lg w-full text-[#DDDFE2] h-20 font-bold'>
                        ...
                        <div className="w-full absolute bottom-0  bg-gray-300 rounded-full h-2">
                            <div className="bg-color h-2 rounded-full w-[75%]"></div>
                        </div>
                    </div>
                    <div className=' bg-[#1d293a] relative rounded-lg w-full text-[#DDDFE2] h-20 font-bold'>
                        <div className='flex justify-between p-5'>
                    ...
                    <div className=' bg-[#1d293a] relative rounded-lg w-full text-[#DDDFE2] h-20 font-bold'>
                        ...
                        <div className="w-full absolute bg-gray-300 bottom-0 rounded-full h-2">
                            <div className="bg-color h-2 rounded-full w-[55%]"></div>
                        </div>
                    </div>
                    <div className=' bg-[#1d293a] relative rounded-lg w-full text-[#DDDFE2] h-20 font-bold'>
                        <div className='flex justify-between p-5'>
                    ...
                    <div className=' bg-[#1d293a] relative rounded-lg w-full text-[#DDDFE2] h-20 font-bold'>
                        ...
                        <div className="w-full absolute bg-gray-300 bottom-0 rounded-full h-2">
                            <div className="bg-color h-2 rounded-full w-[30%]"></div>
                        </div>
                    </div>
                    <div className=' bg-[#1d293a] relative rounded-lg w-full text-[#DDDFE2] h-20 font-bold'>
                        <div className='flex justify-between p-5'>
                        ...
                        <div className="w-full absolute bg-gray-300 bottom-0 rounded-full h-2">
                            <div className="bg-color h-2 rounded-full w-[50%]"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                    <div className=' bg-[#1d293a] relative rounded-lg w-full text-[#DDDFE2] h-20 font-bold'>
                        ...
                        <div className="w-full absolute bottom-0  bg-gray-300 rounded-full h-2">
                            <div className="bg-color h-2 rounded-full w-[80%]"></div>
                        </div>
                    </div>
                    <div className=' bg-[#1d293a] relative rounded-lg w-full text-[#DDDFE2] h-20 font-bold'>
                        <div className='flex justify-between p-5'>
                    ...
                    <div className=' bg-[#1d293a] relative rounded-lg w-full text-[#DDDFE2] h-20 font-bold'>
                        ...
                        <div className="w-full absolute bg-gray-300 bottom-0 rounded-full h-2">
                            <div className="bg-color h-2 rounded-full w-[70%]"></div>
                        </div>
                    </div>
                    <div className=' bg-[#1d293a] relative rounded-lg w-full text-[#DDDFE2] h-20 font-bold'>
                        <div className='flex justify-between p-5'>
                        ...
                        <div className="w-full absolute bg-gray-300 bottom-0 rounded-full h-2">
                            <div className="bg-color h-2 rounded-full w-[45%]"></div>
                        </div>
                    </div>
                </div>
            </div>
