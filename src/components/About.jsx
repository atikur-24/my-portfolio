            ...
            <div className="md:flex justify-between gap-10 mt-10">
                ...
                <div className="md:w-2/3 pt-8 md:pt-0 flex flex-col justify-between">
                    <p className="md:leading-7 text-justify">
                        Hello! I&apos;m Atikur Rahman, a passionate and driven front-end developer specializing in crafting captivating and user-centric web experiences. With 1 years of work
                        experience. Dedicated to delivering high-quality code and optimizing website performance, I aim to contribute to a dynamic team and help drive innovative projects in a
                        fast-paced environment. I pride myself on doing quality work and maintain excellent communication. I work with JavaScript, ReactJS, NextJS, NodeJS, MongoDB and also enjoy
